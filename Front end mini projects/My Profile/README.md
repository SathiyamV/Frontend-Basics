...
✗ The photo <img> tag should have a border width of 2px (+ 2 related tests)
✗ The 3rd <div> tag should have an <h2> tag (+ 2 related tests)
✗ There should be a 4th <div> tag in the <body> tag (+ 7 related tests)
✗ The 5th <div> tag should have an <a> tag (+ 2 related tests)